...
#include "QSPI.h"
    ...
    /**
      ...
      */
#define W25Q64_FLASH_SIZE                  0x1000000 /* 128 MBits => 16MBytes */
#define W25Q64_SECTOR_SIZE                 0x10000   /* 256 sectors of 64KBytes */
#define W25Q64_SUBSECTOR_SIZE              0x1000    /* 4096 subsectors of 4kBytes */
#define W25Q64_PAGE_SIZE                   0x100     /* 65536 pages of 256 bytes */
...
#define W25Q64_NVCR_LOCK                   ((uint16_t)0x0001) /*!< Lock nonvolatile configuration register */
...
#define W25Q64_EVCR_VPPA                   ((uint8_t)0x08)    /*!< Vpp accelerator */
...
#define W25Q64_FSR_VPPERR                  ((uint8_t)0x08)    /*!< Invalid voltage during program or erase */
